  ...
  return (
    <div className="container" style={{ paddingTop: '100px', paddingBottom: '100px', color: 'var(--text-main)' }}>
      ...
      <div className="glass-panel" style={{ padding: '3rem', borderRadius: '16px' }}>
        <h2 style={{ marginBottom: '1rem', color: 'white' }}>1. Information We Collect</h2>
        ...
        <h2 style={{ marginBottom: '1rem', color: 'white' }}>2. How We Use Your Information</h2>
        ...
        <h2 style={{ marginBottom: '1rem', color: 'white' }}>3. Data Security</h2>
        <p style={{ color: 'var(--text-muted)', marginBottom: '2rem', lineHeight: '1.8' }}>
